...
use Ecole\AdminBundle\Form\ActualiteType;
...
class ActualiteController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('EcoleAdminBundle:Actualite:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EcoleAdminBundle:Actualite')->find($id);
        ...
        return $this->render('EcoleAdminBundle:Actualite:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('EcoleAdminBundle:Actualite:edit.html.twig', array(
            'entity'      => $entity,
